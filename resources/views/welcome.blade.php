                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav ms-auto">
                                ...
                                <li><a href="{{ route('chart.new') }}"><i class="fa fa-shopping-cart"></i> Cart</a></li>
                    ...
                    <div class="carousel-inner" role="listbox">
                        @foreach( $slider as $row )
                            <div class="item {{ $loop->first ? ' active' : '' }}" >
                                <img src="{{ $row->slider_image }}"  style="width: 100%; height: 400px;">
                            </div>
                        @endforeach
                    </div>
                        ...
                        <div class="panel-group category-products" id="accordian">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title"><a href="{{ route('categoryby.page',$row->category_id) }}">{{ $row->category_name }}</a></h4>
                                </div>
                                @endforeach
                        ...
                        <div class="brands_products">
                            ...
                            <div class="brands-name">
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li><a href="{{ route('manufactureby.page',$row->id) }}"><span class="pull-right">(50)</span>{{$row->manufacture_name}}</a></li>
                ...
                <div class="row">
                    <div class="col-sm-2">
                        <div class="companyinfo">
                            ...
                            <p>Our Delivery Man</p>
                        </div>
                    </div>

                    <div class="col-sm-7">

                        @foreach ($deliveryman as $row)

                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                        <img src="{{ URL::to($row->man_image) }}" alt="" />
                                    </div>
                        ...
                        {{-- <div class="col-sm-3">
                            {{ asset('frontend/images/home/iframe1.png') }}
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
