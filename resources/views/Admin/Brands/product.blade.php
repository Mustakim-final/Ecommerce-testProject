...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card">
                    <div class="card-header">{{ __('Add Brand Product') }}</div>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('brandproduct.add') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="brand_id" class="form-control">
                                        ...
                                        <option value="{{ $row->id }}" class="text-info">{{ $row->brand_name }}</option>
                                        @endforeach
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Product short description</label>
                                    <textarea name="description_long" class="form-control" rows="4" id=""></textarea>
                                </div>
